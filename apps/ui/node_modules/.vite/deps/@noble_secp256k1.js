...
var subtle = () => {
  var _a;
  return ((_a = cr()) == null ? void 0 : _a.subtle) ?? err("crypto.subtle must be defined");
};
...
var signAsync = async (msgh, priv, opts = signOpts) => {
...
*/
//# sourceMappingURL=@noble_secp256k1.js.map
